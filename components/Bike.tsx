...
export default function Bike() {
  ...
  return (
    <main className={styles.bike}>
      ...
      <section>
        <BikeCard side={0} pic="/bike/b1.png" link="none" title="Bike Name" des = "Lorem ipsum dolor sit amet consectetur adipisicing elit. Odit eaque voluptatem minus sapiente facere vitae, doloremque voluptas ad"/>
        <BikeCard side={1} pic="/bike/b1.png" link="none" title="Bike Name" des = "Lorem ipsum dolor sit amet consectetur adipisicing elit. Odit eaque voluptatem minus sapiente facere vitae, doloremque voluptas ad"/>
        <BikeCard side={0} pic="/bike/b1.png" link="none" title="Bike Name" des = "Lorem ipsum dolor sit amet consectetur adipisicing elit. Odit eaque voluptatem minus sapiente facere vitae, doloremque voluptas ad"/>
        <BikeCard side={1} pic="/bike/b1.png" link="none" title="Bike Name" des = "Lorem ipsum dolor sit amet consectetur adipisicing elit. Odit eaque voluptatem minus sapiente facere vitae, doloremque voluptas ad"/>
